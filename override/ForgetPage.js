  ...
  render() {
    ...
    return (
      <div className="dex-login-container">
        {/* Background elements matching LoginPage */}
        ...
        {/* Right side with form matching LoginPage */}
          ...
          <div className="login-content-container">
            <div className="modern-bordered-panel">
              ...
              <div className="form-header">
                <h2 className="form-title">{i18next.t("forget:Reset password")}</h2>
                <p className="form-subtitle">Follow the steps to reset your password</p>
              </div>
              ...
              {/* Form content */}
              <div style={{width: "100%", maxWidth: "325px", margin: "0 auto"}}>
                {this.renderForm(application)}
              </div>
            </div>

            {/* Footer matching LoginPage */}
